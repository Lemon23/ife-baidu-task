...
function init() {
  ...
  document.getElementById("aqi-table").addEventListener("click", function(count){
    if(count.target.nodeName.toLowerCase() === 'button') {
      delBtnHandle.call(null, count.target.dataset.city);
    }
  })
}
